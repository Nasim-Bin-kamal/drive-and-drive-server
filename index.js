...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.lzd4k.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
app.get("/", (req, res) => {
  res.send("Hello!! From drive and drive server!!!");
});
